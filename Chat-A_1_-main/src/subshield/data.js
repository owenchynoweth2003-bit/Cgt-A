export const initialData = {
  ...
  contractors: [
    {
      ...
      requirements: "Requires $2M umbrella and primary non-contributory wording.",
    ...
    },
    {
      ...
      requirements: "30-day cancellation notice required. Include WOS when available.",
  ...
  activity: [
    { id: "a1", title: "Workers' Comp is critical", body: "Expires in 4 days. Renew before routing new packages.", time: "Today" },
    { id: "a2", title: "COI package routed", body: "Turner Construction · Downtown Marriott Remodel · 6 verified files", time: "2 days ago" },
    { id: "a3", title: "GL entered renewal window", body: "General Liability has 45 days remaining.", time: "12 days ago" },
  ],
};
